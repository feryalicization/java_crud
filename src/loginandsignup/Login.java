...
public class Login extends javax.swing.JFrame {
    ...
    private void LoginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginBtnActionPerformed
        ...
        SUrl = "jdbc:mariadb://localhost:3307/test";
        SUser = "root";
        SPass = "1234";
        int notFound = 0;
        try {
            ...
            if(notFound == 1){
                ...
                this.dispose();
                    ...
                    JOptionPane.showMessageDialog(new JFrame(), "Incorrect or password", "Error", JOptionPane.ERROR_MESSAGE);
                }

            }else{
               JOptionPane.showMessageDialog(new JFrame(), "Incorrect email", "Error",
                        JOptionPane.ERROR_MESSAGE);
            }
            password.setText("");
